        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            {safeData.map((item) => {
                ...
                return (
                    <div
                        key={item.id}
                        className="group flex flex-col h-full bg-gray-900/40 backdrop-blur-md rounded-3xl overflow-hidden border border-white/10 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 will-change-transform"
                    >
                        <div className="relative w-full aspect-video bg-gray-950 overflow-hidden">
                            ...
                            {/* Type Badge Overlay — uses design-system tokens */}
                            <div className="absolute top-4 left-4 z-10">
                                <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold backdrop-blur-md border shadow-sm ${
                                    item.type === 'video'
                        ...
                        <div className="flex flex-col flex-grow p-6 md:p-8 bg-gray-900/20">
                            <div className="flex items-start justify-between gap-4 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold text-white group-hover:text-primary-light transition-colors duration-300">
                                    {item.title}
                                </h3>
                            </div>
                            ...
                            <div className="mt-auto pt-6 flex items-center justify-between">
                                <a
                                    ...
                                    className="inline-flex items-center text-sm font-bold text-primary-light hover:text-primary group/link"
                                >
                                    Open Source Media
