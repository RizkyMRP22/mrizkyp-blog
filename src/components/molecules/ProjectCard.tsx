...
export default function ProjectCard({ title, description, tags, highlights, image, category, githubUrl, webUrl, mobileUrl }: ProjectCardProps) {
    ...
    return (
        <Card className="!p-0 flex flex-col h-full overflow-hidden group border border-white/5 bg-surface/40 backdrop-blur-sm">
            ...
            <div className="relative h-48 sm:h-56 w-full shrink-0 overflow-hidden bg-black/20">
                {image && !imgError ? (
                    <>
