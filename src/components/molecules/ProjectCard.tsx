...
export default function ProjectCard({ title, description, tags, highlights, githubUrl, demoUrl }: ProjectCardProps) {
    return (
        <Card className="flex flex-col h-full">
            ...
            <div className="flex gap-3 pt-4 border-t border-card-border">
                ...
                {demoUrl && demoUrl !== '#' && (
                    <a href={demoUrl} target="_blank" rel="noopener noreferrer" className="text-sm text-secondary hover:text-white transition-colors flex items-center gap-1">
